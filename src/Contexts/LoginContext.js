...
export function LoginProvider({ children }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      response.data === "ACCOUNT DOES NOT EXISTS" &&
        setErrorState("ACCOUNT DOES NOT EXISTS");
    }
  };
  const handleSignup = async (e) => {
    ...
    try {
      ...
      const { response } = error;
      response.data === "ACCOUNT DATA DOES NOT CONTAIN ALL FIELDS" &&
        setErrorState("ACCOUNT DATA DOES NOT CONTAIN ALL FIELDS");
      response.data === "USERNAME EXISTS ALREADY" &&
        setErrorState("USERNAME EXISTS ALREADY");
    }
  };
