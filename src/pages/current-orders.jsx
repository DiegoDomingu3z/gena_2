...
const CurrentOrders = () => {
  ...
  return (
    <Layout title={"Gena | Current Orders"}>
              ...
              <div>
                {tab == "approve-order" && 
                  ...
                  >
                    ...
                    <OrderTableApprovals setApprovalOrderId={setApprovalOrderId} setModalState={setModalState} />
                  </div>
                }
              </div>
            </div>
      ...
      <Modal width={"950px"} title="Labels in this order" open={modalState} onCancel={() => setModalState(false)} 
      cancelButtonProps={{
            style: { display: 'none' },
          }}
      okButtonProps={{
