...
const NewLabel = () => {
  ...
  useEffect(() => {
    if (files.length > 0 && files.length < 2) {
      ...
      let docNum = files[0].name.slice(
        files[0].name.length - 11,
        files[0].name.length - 4
      );
      setDocNum(docNum);
      const formData = new FormData();
      formData.append("pdf", files[0]);
      dispatch(findLabelFields(formData))
        .then((res) => {
  ...
  const nameGeneratorForLabel = (inputString, materialArrr) => {
    ...
    const lowercaseExcluded = materialArrr.map((substring) =>
      substring.name.toLowerCase()
    );
    ...
    for (let i = 0; i < 2; i++) {
      let check = checkString(
        mainNameWithoutHyphens.toLowerCase(),
        lowercaseExcluded,
        i
      );
      options.push(check);
          ...
          >
            {({ isSubmitting, values, setFieldValue }) => (
              <Form id="newLabelForm">
                <div className="flex justify-around gap-8">
                  <div className="grow">
                    ...
                    >
                      ...
                      {labelName.length > 0
                        ? labelName.map((l) => (
                            <option key={l._id} value={l}>
                              {l}
                            </option>
                          ))
                        : null}
                      {files.length > 0 ? (
                        <option value="custom" className="text-gray-500">
                          Input Custom Name
                        </option>
                      ) : (
                ...
                <div className="grid grid-cols-2 gap-x-8 mt-10">
                  ...
                  <div className="">
                    ...
                    <Field
                      ...
                      className="bg-gray-50 border border-gray-300
                                        text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block p-2.5 dark:bg-gray-700
                                        dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 w-full"
                      required
                    >
                ...
                <div className="grid grid-cols-2 gap-x-8 mt-10">
                  <div className="">
                    ...
                    <Field
                      ...
                      required
                    >
                      <option className="text-gray-600" disabled selected>
                        SELECT CATEGORY
                      </option>
                      {category.categories
                  ...
                  <div className="">
                    ...
                    <Field
                      component="select"
                      disabled={activeSubCats.length == 0 && true}
                      name="subCategoryId"
                      id="subCategoryId"
                      className="bg-gray-50 border border-gray-300
                                        text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block p-2.5 dark:bg-gray-700
                ...
                <div>
                  {files.length > 0 ? (
                    <div className="border-t-4 mt-2">
                      <button
                        onClick={deleteLabels}
                        className="mt-3 bg-red-500 p-1 px-3 rounded-md text-white"
                      >
                        Remove Labels
                      </button>
                    </div>
                    ...
                    {files.length > 0 ? (
                      <div className="mt-5">
                        <div className="grow flex mb-5">
                          ...
                          <Field
                            onClick={handleBulkCheckBoxChange}
                            type="checkbox"
                            name="isBulkLabel"
                            className="h-4 ms-5 w-4 text-primary-600 focus:outline outline-2 outline-offset-2 rounded-md"
                          />
                        </div>
                        {isBulkChecked == true ? (
                          <div className="grow flex mb-5">
                            ...
                            <Field
                              onClick={handleSerialCheckChange}
                              type="checkbox"
                              name="isSerialChecked"
                              className="h-4 ms-5 w-4 text-primary-600 focus:outline outline-2 outline-offset-2 rounded-md"
                            />
                            {startingSerial && isSerialCheck ? (
                              <div className="ms-3">{startingSerial}</div>
                            ) : null}
                          </div>
                        ) : null}
                        <iframe
                      ...
                      <div className="grow mt-5">
                        <div className="flex">
                          <div
                            className="extraOutline p-4 bg-white w-max em-auto rounded-lg"
                            {...getRootProps()}
                          >
                            <div className="file_upload p-5 relative border-4 border-dotted border-gray-300 rounded-lg">
                              <svg
                                className="text-[#28aeeb] w-24 mx-auto mb-4"
                              ...
                              <div className="input_field flex flex-col w-max mx-auto text-center">
                                <label>
                                  ...
                                  />
                                  <div
                                    className="text bg-[#28aeeb] text-white border border-gray-300 rounded 
                                                        font-semibold cursor-pointer p-1 px-3 hover:bg-[#3095c4]"
                                  >
                                    Select
                                  </div>
                                </label>

                                <div className="title text-[#28aeeb] uppercase">
                                  or drop files here
                                </div>
                              </div>
                            </div>
                        ...
                        {files.length > 1 ? (
                          <div className="mt-20">
                            <iframe
                              ...
                              frameborder="0"
                            ></iframe>
                            <div className="block mb-4 text-md font-medium text-gray-900 mt-7">
                              Label to Print
                            </div>
                          </div>
                        ) : (
                          <div className="grow mt-8">
                            <div class="flex">
                              <div
                                class="extraOutline p-4 bg-white w-max em-auto rounded-lg"
                                {...getRootProps()}
                              >
                                <div class="file_upload p-5 relative border-4 border-dotted border-gray-300 rounded-lg">
                                  <svg
                                    class="text-[#28aeeb] w-24 mx-auto mb-4"
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="none"
                                    viewBox="0 0 24 24"
                                    stroke="currentColor"
                                  ...
                                  <div class="input_field flex flex-col w-max mx-auto text-center">
                                    <label>
                                      <input
                                        ...
                                        {...getInputProps()}
                                      />
                                      <div class="text bg-[#28aeeb] text-white border border-gray-300 rounded font-semibold cursor-pointer p-1 px-3 hover:bg-[#3095c4]">
                                        Select
                                      </div>
                                    </label>

                                    <div class="title text-[#28aeeb] uppercase">
                                      or drop files here
                                    </div>
                                  </div>
                                </div>
                ...
                <div className="text-end">
                  <button
                    className="bg-[#28aeeb] p-2 px-5 rounded-lg text-white"
                    type="submit"
                  >
                    submit
                  </button>
