            ...
            {users.length > 0 ? (
              users.map((u) => (
                <div
                  ...
                  className={
                    "w-full grid grid-cols-6 p-5 border-b hover:bg-gray-100 transition-all ease-in-out cursor-pointer  justify-between"
                  }
                  key={u._id}
                >
                  <span>
                  ...
                  <span>
                    {u.groupLead != " " || undefined ? u.groupLead : "N/A"}
                  </span>
                  <span>
                    {u.teamLead != " " || undefined ? u.teamLead : "N/A"}
                  </span>
              ...
              <div className="flex justify-center">
                {deptName ? (
                  <div className="mt-60 text-lg font-bold antialiased">
                    No users in {deptName}
                  </div>
                ) : (
                  <div className="mt-60 ">
