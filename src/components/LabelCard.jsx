                    ...
                    <div className="bg-white w-full h-76 laptop:h-auto rounded-lg drop-shadow-md font-genaPrimary">
                      ...
                      <div className="p-4">
                        ...
                        <div>
                          <Field
                           ...
                           dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            type="number"
                            max={l.maxOrderQty}
                            placeholder={`Enter Qty: MAX(${l.maxOrderQty})`}
                            name="qty"
                            required
                            key={l.docNum}
                            id={l.docNum}
                                ...
                                if (f.name === "AREA") {
                                  return (
                                    ...
                                    >
                                      <Field
                                        component="select"
                                        className="bg-gray-50 ms-3.5 border border-gray-300 mt-1 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-11/12 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        name={f.name}
                                        id={f.name}
                                        type={f.type}
                                        placeholder={f.name}
                                  ...
                                  return (
                                    ...
                                    >
                                      ...
                                      <div className="">
                                        {f.type === "checkbox" ? (
                                          <label htmlFor={f.name} className="">
                                            {f.name.toUpperCase()}
                                          </label>
                                        ) : null}
                                      </div>
                        ...
                        <div className="text-center mt-3">
                          <button
                            className="bg-[#1baded] px-3 py-1 rounded-lg text-white mt-2 hover:bg-[#16b9ff] hover:scale-110 hover:shadow-md transition-all ease-in-out"
                            type="submit"
