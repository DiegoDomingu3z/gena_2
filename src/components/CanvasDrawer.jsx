...
import { faCirclePlus, faSuitcase, faHouse, faList, faArrowLeftLong } from '@fortawesome/free-solid-svg-icons'
  ...
  return (
    <>
      <div className='w-full flex flex-col justify-center mb-auto'>
        ...
        <Link href={'/home'} className={router.pathname !== '/home' && user.accessToken ? "flex items-center gap-5 mb-5" : "hidden"}>
