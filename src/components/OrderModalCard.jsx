                      ...
                      if (field.name == "AREA") {
                        return (
                          <div
                            key={field._id}
                            className={
                              field.type === "checkbox" ? "flex gap-5" : ""
                            }
                          >
                            <Field
                              component="select"
                              ...
                              key={field._id}
                              required={
                                field.type === "checkbox" ? false : false
                              }
                            >
                    ...
                    <button
                      className={`${
                        ...
                        activeOrder.status == "delivered"
                          ? "hidden"
                          : ""
                      } bg-[#1baded] px-3 py-1 rounded-lg text-white mt-2 hover:bg-[#16b9ff] hover:scale-110 hover:shadow-md transition-all ease-in-out`}
                      type="submit"
