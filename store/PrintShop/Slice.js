  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(printOrder.fulfilled, (state, action) => {
        state.approvedOrders.orders = state.approvedOrders.orders.filter(
      ...
      .addCase(deleteDeliveredOrder.fulfilled, (state, action) => {
        state.loading = false;
        state.deliveredOrders.orders = state.deliveredOrders.orders.filter(
      ...
      .addCase(deliverOrder.fulfilled, (state, action) => {
        state.loading = false;
        state.processingOrders.orders = state.processingOrders.orders.filter(
          (o) => o._id != action.payload._id
        );
      })
      ...
      .addCase(updateToPickup.fulfilled, (state, action) => {
        state.pickupOrders.orders = state.pickupOrders.orders.filter(
          (o) => o._id != action.payload._id
        );
        state.loading = false;
      })
